...
public class CorruptionAuntsHouse : MonoBehaviour
{
    ...
    */
    ...
    {
        if (other.CompareTag("AuntsHouseInteractable")) //this tag is put on the parent of the visual trigger obj
        {
        ...
        if (other.CompareTag("AuntsHouseNonInteractable")) //this tag is put on every obj that can be corrupted - but not interactable
        {
            CorruptionController.SetOneUncorruptionMaterial(other.gameObject);
            //Debug.Log("No corruption");
        }
